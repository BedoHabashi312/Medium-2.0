...
function Post({ post }: Props) {
    ...
    return <main>
        ...
        {submitted ? (
            ...
            max-w-2xl mx-auto">
                <h3 className="text-3xl fot-bold">Thank you for submitting your comment!</h3>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-10 max-w-2xl mx-auto mb-10">
                ...
                <label className="block mb-5">
                    ...
                    <input
                        ...
                        className="shadow border rounded py-2 px-3 form-input nt-1 block w-full 
                ...
                <label className="block mb-5">
                    ...
                    <input
                        ...
                        className="shadow border rounded py-2 px-3 form-input nt-1 block w-full 
                ring-yellow-500 outline-none focus:ring"
                        placeholder="ex: John@gmail.com" type="email" />
                </label>
                <label className="block mb-5">
